...
function Header() {
  return (
    <header className="bg-white shadow-md py-3 px-6 fixed top-0 left-0 right-0 z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <a href="#" className="text-gray-600 hover:text-gray-900 text-sm font-medium">Safety</a>
          <a href="#" className="text-gray-600 hover:text-gray-900 text-sm font-medium">Support</a>
        </nav>
        
        {/* Auth buttons */}
        <div className="flex items-center gap-4">
          <Link to="/login" className="bg-white hover:bg-gray-100 text-gray-800 font-medium py-2 px-4 border border-gray-300 rounded-full shadow-sm transition-colors">
            Log in
          </Link>
        </div>
      </div>
