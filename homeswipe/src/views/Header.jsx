      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          <div className="relative">
            ...
            <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 to-blue-500 rounded-lg blur opacity-30 group-hover:opacity-70 transition duration-300"></div>
          </div>
          <span className="font-bold text-xl bg-clip-text text-transparent bg-gradient-to-r from-gray-800 to-gray-600 group-hover:from-gray-900 group-hover:to-gray-700 transition-all duration-300 drop-shadow-sm">
            Home<span className="text-blue-600 group-hover:text-blue-500">Swipe</span>
          </span>
        </Link>
        ...
        <div className="flex items-center gap-4">
          <Link to="/login" className="group relative inline-flex items-center justify-center">
            <span className="absolute -inset-0.5 bg-gradient-to-r from-purple-600 to-blue-500 rounded-full blur opacity-30 group-hover:opacity-70 transition duration-300"></span>
